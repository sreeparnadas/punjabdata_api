...
Route::group(array('prefix' => 'v1'), function() {
    ...
    Route::get('/getActiveAndNextGame','DrawMasterController@getActiveAndNextGame');
    ...
    Route::get('/getTodayResult','ResultDetailsController@getTodayResult');
    Route::post('/getResultsByDate','ResultDetailsController@getResultByDate');
    Route::get('/getAdvanceDraws','DrawMasterController@getAdvanceDrawTimes');
...
Route::group(['prefix' => 'v1',  'middleware' => 'authCheck'], function()
{
    ...
    Route::post('/resultFromCPanel','ResultMasterController@getResultByDateFromCPanel');
